 ...
 *
 * For example, kangaroo  starts at  with a jump distance  and kangaroo  starts at  with a
 * jump distance of . After one jump, they are both at , (, ), so our answer is YES.
 *
 ...
 * moves at a faster rate (meaning ) and is already ahead of the first kangaroo,
 * the first kangaroo will never be able to catch up. Thus, we print NO.
 */
public class NumberLineJumps {
    public static String kangaroo(int x1, int v1, int x2, int v2) {
        if((v2<v1) && ((x2-x1) / (v2-v1) == 0)) return "YES";
        else return "NO";
    }
